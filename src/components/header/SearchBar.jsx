...
export default function SearchBar({value, placeholder, onChange}) {
    ...
    return (
        ...
        <div className="w-full relative text-neutral bg-panel hover:bg-panel/60 rounded-xl shadow-md focus-within:bg-panel/60 focus-within:outline-2 focus-within:outline-neutral pr-10">
